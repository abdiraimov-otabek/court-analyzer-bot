...
- Быстрая оценка объема выборки (0, 1-500, >500 дел).
- Для выборки >500 дел бот предлагает выбор квартала (1-4) и запускает анализ выбранного квартала.
